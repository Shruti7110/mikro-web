          ...
          <div className="container-padding relative z-10">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                EV Automation <span className="text-primary">Lines</span>
              </h1>
              ...
              {automationItems.map((item, index) => (
                ...
                >
                  <div className="flex-1 space-y-6">
                    <div className="bg-white w-16 h-16 rounded-lg flex items-center justify-center shadow-sm border border-slate-100">
                      {item.icon}
                    </div>
