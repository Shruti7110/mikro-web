...
import pharmaAsset from "@assets/image_pharma.png";
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 whitespace-nowrap">
                <span className="text-primary">PHARMACUETICAL AUTOMATION</span>
              </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
              ...
              >
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Understanding the needs for high precision in pharma industry, our designs and integration of special-purpose machinery adheres to the highest levels of accuracy and security. We bridge the gap between complex engineering concepts and reliable manufacturing reality.
                </p>
              ...
              >
                <div className="rounded-xl overflow-hidden shadow-2xl border border-slate-200">
                  <img 
                    src={pharmaAsset} 
                    alt="Pharma Automation Technology" 
            ...
            >
              ...
              <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl bg-black aspect-video relative group">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/pEoOfnAxkPI"
